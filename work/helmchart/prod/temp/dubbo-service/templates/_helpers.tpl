...
- name: aliyun_logs_{{ .Values.name }}_machinegroup
  value: prod-log-group
{{- if  .Values.name | regexMatch "fpv5" }}
- name: aliyun_logs_prod-alert-hm
  value: /data/app-logs/fpv5-web.prod.alert-hm.log.*
- name: aliyun_logs_prod-alert-hm_project
  value: service-monitor
- name: aliyun_logs_prod-alert-hm_logstore
  value: alert-logs
- name: aliyun_logs_prod-alert-hm_machinegroup
  value: service-monitor
{{- end }}
{{- end }}
