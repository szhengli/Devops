...
urlpatterns = [
                ...
                path('webUpdateJOBSvnPath/', views.webUpdateJOBSvnPath, name='webUpdateJOBSvnPath'),
                path('jiraAddUser/', views.jiraAddUser, name='jiraAddUser'),
                path('svnAddUser/', views.svnAddUser, name='svnAddUser'),
                path('branchAddUser/', views.branchAddUser, name='branchAddUser'),
               ]
